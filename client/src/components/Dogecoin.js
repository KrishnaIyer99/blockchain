//Component displays BUY/SELL recommendation for DOGE
...
const Dogecoin = () => {
  ...
  useEffect(() => {
    fetch("/DOGE_PRICE")
      .then(
        (response) => response.json() //Return response as JSON
      )
    ...
    <div className={DogecoinCSS.background_doge}>
      ...
      <div className={DogecoinCSS.body}>
        ...
        <p>
          ...
          time. Despite its satirical nature, some consider it a legitimate
          investment prospect. Dogecoin features the face of the Shiba Inu dog
          from the "Doge" meme as its logo and namesake. It was introduced on
          ...
          It is the current shirt sponsor (sleeve only) of Premier League club
          Watford. Dogecoin.com promotes the currency as the "fun and friendly
          Internet currency", referencing its origins as a "joke." Elon Musk
          frequently mentions or talks about Dogecoin on his Twitter account,
          boosting its popularity significantly in recent years."
          <br></br>
          <br></br>
